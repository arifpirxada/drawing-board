        ...
        case "image":
            ...
            return (
                <KonvaImage
                    ...
                    image={ shape.image }
                    x={ shape.x ? shape.x : (window.innerWidth / 2) - (imageWidth / 2) }
                    y={ shape.y ? shape.y : (window.innerHeight / 2) - (imageHeight / 2) }
                    width={ imageWidth }
                    height={ imageHeight }
                    scaleX={ shape.scaleX }
                    scaleY={ shape.scaleY }
        ...
        case "straight_line":
            return (
                <Line
                    ...
                    id={ shape.id }
                    hitStrokeWidth={ 20 }
                    shapeType={ shape.type === "straight_line" ? "line" : "line" }
                    className="selectable"
                    points={ shape.points }
                    stroke={ shape.fill }
                    strokeWidth={ shape.strokeWidth }
                    ...
                    x={ shape.x }
                    y={ shape.y }
                    tension={ shape.type === "straight_line" ? 0 : 0.2 }
                    lineCap="round"
