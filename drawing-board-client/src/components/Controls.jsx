...
function Controls() {
    ...
    return (
        <div className={ `controls-container h-screen fixed ${controlWidth} transition-all p-3` }>
            ...
            <h2 className="text-white mb-3 font-mono overflow-hidden transition-all select-none">Pens</h2>
            ...
            <h2 className="text-white mb-3 font-mono overflow-hidden transition-all select-none">Eraser</h2>
            ...
            <hr className="border-gray-400 mt-6 mb-2" />
            <h2 className="text-white mb-3 font-mono overflow-hidden transition-all select-none">Color</h2>
            ...
            <hr className="border-gray-400 mt-6 mb-2" />
            <h2 className="text-white mb-3 font-mono overflow-hidden transition-all select-none">Shapes</h2>
