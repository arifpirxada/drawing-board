                    ...
                    <div className="options-row gap-2">
                        <div className="select-wrap">
                            <select onChange={ e => setTextFont(e.target.value) } value={ textFont }
                                ...
                                <option className="bg-gray-800" value="Handlee">Handlee</option>
                                <option className="bg-gray-800" value="Arial">Arial</option>
                                <option className="bg-gray-800" value="Verdana">Verdana</option>
                            </select>
                        ...
                        <div className="select-wrap">
                            <select onChange={ e => setTextFontSize(e.target.value) } value={ textFontSize }
                                ...
                                <option className="bg-gray-800" value="12">12</option><option className="bg-gray-800" value="16">16</option>
                                <option className="bg-gray-800" value="24">24</option><option className="bg-gray-800" value="32">32</option>
                                <option className="bg-gray-800" value="48">48</option>
                            </select>
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="6 9 12 15 18 9" /></svg>
                        </div>
                    </div>
